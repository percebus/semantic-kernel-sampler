namespace JCystems.SemanticKernelSampler.Dotnet.WebApp.Options
{
    ...
    public class CopilotStudioOptions
    {
        ...
        [Required(ErrorMessage = ErrorMessages.EnvironmentIdRequired)]
        ...
        [Required(ErrorMessage = ErrorMessages.SchemaNameRequired)]
        ...
        public static class ErrorMessages
        {
            ...
            public const string EnvironmentIdRequired = $"{AppSettingsOptions.Key}:{nameof(CopilotStudioOptions)}:{nameof(EnvironmentId)} cannot be empty";
            ...
            public const string SchemaNameRequired = $"{AppSettingsOptions.Key}:{nameof(CopilotStudioOptions)}:{nameof(SchemaName)} cannot be empty";
        }
    }
}
