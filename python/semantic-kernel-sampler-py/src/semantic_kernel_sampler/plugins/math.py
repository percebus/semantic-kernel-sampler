...
# SRC: https://github.com/microsoft/semantic-kernel/blob/40734345dcb5be298d524f58b5d3bf2afd835f27/python/samples/learn_resources/plugins/MathPlugin/Math.py   # noqa: E501 # pylint: disable=line-too-long
class MathPlugin(PluginProtocol):
    """
