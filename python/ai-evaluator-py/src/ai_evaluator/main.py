...
from ai_evaluator.dependency_injection.container import container, get_azure_ai_project
...
def run(ctr: Container) -> None:
    ...
    oAzureAIProject = ctr[AzureAIProject]
    noop(oAzureAIProject)
    azure_ai_project = get_azure_ai_project(ctr)  # oAzureAIProject
